...
const APP_SHELL_PATHS = [
  ...
  'js/data/supplementals/week_1_supplemental.js?v=31',
  'js/data/supplementals/luo_phileo.js?v=31',
  'js/data/supplementals/noun_patterns.js?v=31',
  'js/data/supplementals/autos.js?v=31',
  'js/data/supplementals/eimi.js?v=31',
  'js/data/supplementals/custom_supplement.js?v=31',
