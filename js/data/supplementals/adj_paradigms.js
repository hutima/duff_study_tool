(function () {
  ...
  window.registerSupplementalVocabSet(KEY, {
    ...
    cards: [
      ...
      { g: 'πολλοῦ', e: 'of much / of many (masc. Gen. sg.)', required: true },
      { g: 'πολλῷ', e: 'to/for much / many (masc. Dat. sg.)', required: true },
      { g: 'πολλοί', e: 'many (masc. Nom. pl.)', required: true },
      { g: 'πολλούς', e: 'many (masc. Acc. pl.)', required: true },
      { g: 'πολλῶν', e: 'of many (masc. Gen. pl.)', required: true },
      { g: 'πολλοῖς', e: 'to/for many (masc. Dat. pl.)', required: true },
      ...
      { g: 'μεγάλου', e: 'of great (masc. Gen. sg.)', required: true },
      { g: 'μεγάλῳ', e: 'to/for great (masc. Dat. sg.)', required: true },
      { g: 'μεγάλοι', e: 'great (masc. Nom. pl.)', required: true },
      { g: 'μεγάλους', e: 'great (masc. Acc. pl.)', required: true },
      { g: 'μεγάλων', e: 'of great (masc. Gen. pl.)', required: true },
      { g: 'μεγάλοις', e: 'to/for great (masc. Dat. pl.)', required: true },
